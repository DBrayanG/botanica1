...
<div id="center">
  <h1><center>BIENVENIDO AL SISTEMA DE RESTAURANTE BOTANICA!</center></h1>
      <div class="body_text">
      Ordene hoy su comida del menú y se la entregará en la puerta de su casa. Ingrese a nuestras Ofertas Especiales semanales en el menú de Ofertas Especiales. Registre una cuenta con nosotros para disfrutar de pedidos rápidos, entrega y pago conveniente de su comida. Comience ahora iniciando sesión a continuación o registrándose si no tiene una cuenta con nosotros:
  </div>
        ...
        <td style="text-align:center;">
            ...
            <form id="loginForm" name="loginForm" method="post" action="register-exec.php" onsubmit="return registerValidate(this)">
              <table width="450" border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                    <td colspan="2" style="text-align:center;"><font color="#FF0000">* </font>Campos Obligatiros</td>
                </tr>
                <tr>
                  <th>Nombres </th>
...
<div id="footer">
    <div class="bottom_menu"><a href="index.php">Inicio Pagina</a>  |  <a href="aboutus.php">Sobre nosotros</a>  |  <a href="specialdeals.php">Ofertas Especiales</a>  |  <a href="foodzone.php">Menu</a> |<br>
