...
<a href="profile.php">Perfil</a> | <a href="categories.php">Categorías</a> | <a href="foods.php">Alimentos</a> | 
...
<CAPTION><h3>ESTADO ACTUAL</h3></CAPTION>
<tr>
    <th>Miembros registrados</th>
    <th>Pedidos realizados</th>
    <th>Pedidos procesados</th>
    <th>Pedidos pendientes</th>  
    <th>Mesa (s) reservadas</th>
    <th>Mesa(s) Asignada</th>
    <th>Mesa (s) pendiente</th>
    <th>Salón de fiestas Reservado</th>
    <th>Salón de fiestas Asignado</th>
    <th>Salón de fiestas Pendiente</th>    
</tr>
...
<form name="foodStatusForm" id="foodStatusForm" method="post" action="index.php" onsubmit="return statusValidate(this)">
    ...
    <CAPTION><h3>CALIFICACIONES DE CLIENTES (100%)</h3></CAPTION>
         <tr>
            <td>Comida</td>
            <td width="168"><select name="food" id="food">
            <option value="select">- seleccionar comida -
            <?php 
            ...
            <td><input type="submit" name="Submit" value="Mostrar Calificaciones" /></td>
         </tr>
    </table>
</form>
