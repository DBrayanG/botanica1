...
<title><?php echo APP_NAME ?>:Registro fallido</title>
...
<p>Estás viendo esta página porque el salón de fiestas ya está reservado. <a href="partyhalls.php">Haga clic aquí</a> para volver a intentarlo.</p>
</div>
</div>
