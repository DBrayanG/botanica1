...
<title><?php echo APP_NAME ?>:Error de inicio de sesion</title>
...
<div class="error">¡Error de inicio de sesion!</div>
  <p>Por favor revise su correo electrónico y contraseña. <a href="login-register.php"> Haga clic aquí</a> para volver a intentarlo.</p>
  </div>
</div>
