...
INSERT INTO `food_details` (`food_id`, `food_name`, `food_description`, `food_comida`, `food_photo`, `food_category`) VALUES
...
(8, 'Cual es el nombre de tu primera mascota?'),
(9, 'Cual es el nombre de tu primera novia?');
